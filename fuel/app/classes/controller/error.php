...
class Controller_Error extends \Controller
{
    ...
    public function action_403()
    {
        ...
        $output['error_head'] = Lang::get('error.403_error_head');
        $output['error_content'] = Lang::get('error.403_error_content', array('home_link' => Uri::base()));

        // <head> output ----------------------------------------------------------------------------------------------
        $output['page_title'] = Lang::get('error.403_page_title');
        // <head> output ----------------------------------------------------------------------------------------------

        return Response::forge(Theme::instance()->view('error/403_v', $output)->auto_filter(false), 403);
    }// action_403
