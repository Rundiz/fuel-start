<h1><?php echo (\Uri::segment(3) == 'add' ? __('siteman_add') : __('siteman_edit')); ?></h1>
...
<?php echo \Extension\Form::openMultipart(array('class' => 'form-horizontal', 'role' => 'form')); ?> 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <div class="help-block"><?php echo __('siteman_donot_enter_http_only_domain'); ?></div>
        </div>
    </div>
    <div class="form-group">
            ...
            <div class="col-sm-5">
                <select name="site_status" id="site_status" class="form-control chosen-select account_status">
                    <option value="0"<?php if (isset($site_status) && $site_status == '0') { ?> selected="selected"<?php } ?>><?php echo __('admin_disable'); ?></option>
                    <option value="1"<?php if (isset($site_status) && $site_status == '1') { ?> selected="selected"<?php } ?>><?php echo __('admin_enable'); ?></option>
                </select>
            </div>
        </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            <a href="<?php echo \Uri::create('admin/siteman'); ?>" class="btn btn-default"><?php echo __('admin_cancel'); ?></a>
        </div>
    </div>
<?php echo \Form::close(); ?> 