...
<div class="alert alert-block alert-warning browser-alert browser-alert-<?php echo $browser_check; ?>">
    <?php 
    if ($browser_check == 'no') {
        echo __('admin_get_modern_browser');
    } else {
        echo __('admin_using_unknow_browser');
    }
    ?> 
</div>
            ...
            <div class="admin-login-page-layout">
                <div class="login-block">
                    ...
                    <?php echo \Form::open(array('action' => \Uri::main() . '?rdr=' . $go_to, 'class' => 'form-horizontal', 'role' => 'form', 'onsubmit' => 'return ajaxAdminLogin($(this));')); ?> 
                        <noscript><div class="alert alert-danger"><?php echo __('admin_please_enable_javascript'); ?></div></noscript>
                ...
                <div class="requirement-check-block">
                    <span><?php echo __('admin_web_browser'); ?>: <small class="glyphicon glyphicon-<?php if (isset($browser_check)) {echo str_replace(array('yes', 'unknow', 'no'), array('ok', 'exclamation-sign', 'remove'), $browser_check);} ?>"></small></span>
                    <span><?php echo __('admin_javascript'); ?>: <small class="glyphicon glyphicon-remove" id="login-page-js-check"></small></span>
                </div><!--.requirement-check-block-->
                
                <div class="forgot-user-pw-block">
                    <?php echo \Html::anchor('account/forgotpw', __('account_forgot_username_or_password'), array('class' => 'btn btn-default btn-block')); ?> 
                </div>
