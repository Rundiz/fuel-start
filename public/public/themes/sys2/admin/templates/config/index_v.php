<h1><?php echo __('config_global_configuration'); ?></h1>
...
<?php echo \Form::open(array('class' => 'form-horizontal', 'role' => 'form')); ?> 
    ...
    <div class="config-page-form-tab-container">
        <ul class="nav nav-tabs bootstrap3-tabs">
            <li><a href="#tabs-website" data-toggle="tab"><?php echo __('config_website'); ?></a></li>
            <li><a href="#tabs-account" data-toggle="tab"><?php echo __('config_user_account'); ?></a></li>
            <li><a href="#tabs-email" data-toggle="tab"><?php echo __('config_email'); ?></a></li>
            <li><a href="#tabs-content" data-toggle="tab"><?php echo __('config_content'); ?></a></li>
            <li><a href="#tabs-media" data-toggle="tab"><?php echo __('config_media'); ?></a></li>
            <li><a href="#tabs-ftp" data-toggle="tab"><?php echo __('config_ftp'); ?></a></li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="tabs-account">
                <div class="row">
                    <div class="col-sm-6">
                        <h2><?php echo __('config_account_registration'); ?></h2>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <label class="checkbox-inline">
                                    <?php echo \Extension\Form::checkbox('member_allow_register', '1', (isset($member_allow_register) && $member_allow_register == '1' ? true : false), array('id' => 'cfg-member_allow_register', 'class' => 'custom-checkbox')); ?> <?php echo __('config_member_allow_register'); ?> 
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <label class="checkbox-inline">
                                    <?php echo \Extension\Form::checkbox('member_register_notify_admin', '1', (isset($member_register_notify_admin) && $member_register_notify_admin == '1' ? true : false), array('id' => 'cfg-member_register_notify_admin', 'class' => 'custom-checkbox')); ?> <?php echo __('config_member_register_notify_admin'); ?> <span class="text-muted">(<?php echo __('config_email_notification_still_send_when_require_admin_to_verify_register_user'); ?>)</span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cfg-member_verification" class="col-sm-12"><?php echo __('config_member_verification'); ?>:</label>
                            <div class="col-sm-12">
                                <?php 
                                echo \Extension\Form::select('member_verification', (isset($member_verification) ? $member_verification : ''), 
                                    array(
                                        '0' => __('config_member_verification_not_verify'),
                                        '1' => __('config_member_verification_by_email'),
                                        '2' => __('config_member_verification_by_admin'),
                                    ), 
                                    array(
                        ...
                        <div class="form-group">
                            <label for="cfg-member_admin_verify_emails" class="col-sm-12"><?php echo __('config_member_admin_verify_emails'); ?>: <span class="txt_require">*</span></label>
                            <div class="col-sm-12">
                                ...
                                <div class="help-block"><?php echo __('config_member_admin_verify_emails_help'); ?></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cfg-member_disallow_username" class="col-sm-12"><?php echo __('config_member_disallow_username'); ?>:</label>
                            <div class="col-sm-12">
                                ...
                                <div class="help-block"><?php echo __('config_member_disallow_username_help'); ?></div>
                            </div>
                        </div>
                        
                        <h2><?php echo __('config_account_security'); ?></h2>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <label class="checkbox-inline">
                                    <?php echo \Extension\Form::checkbox('simultaneous_login', '1', (isset($simultaneous_login) && $simultaneous_login == '1' ? true : false), array('id' => 'cfg-simultaneous_login', 'class' => 'custom-checkbox')); ?> <?php echo __('config_account_simultaneous_login'); ?> 
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cfg-member_max_login_fail" class="col-sm-12"><?php echo __('config_member_max_login_fail'); ?>:</label>
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon"><?php echo __('config_member_max_login_fail_time'); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cfg-member_login_fail_wait_time" class="col-sm-12"><?php echo __('config_member_login_fail_wait_time'); ?>:</label>
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon"><?php echo __('config_member_login_fail_wait_time_minute'); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cfg-member_login_remember_length" class="col-sm-12"><?php echo __('config_member_login_remember_length'); ?>:</label>
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon"><?php echo __('config_member_login_remember_length_day'); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cfg-member_confirm_wait_time" class="col-sm-12"><?php echo __('config_member_confirm_wait_time'); ?>:</label>
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon"><?php echo __('config_member_confirm_wait_time_minute'); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <label class="checkbox-inline">
                                    <?php echo \Extension\Form::checkbox('member_email_change_need_confirm', '1', (isset($member_email_change_need_confirm) && $member_email_change_need_confirm == '1' ? true : false), array('id' => 'cfg-member_email_change_need_confirm', 'class' => 'custom-checkbox')); ?> <?php echo __('config_member_email_change_need_confirm'); ?> 
                                    <span class="text-muted">(<?php echo __('config_member_email_change_need_confirm_help'); ?>)</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <h2><?php echo __('config_account_avatar'); ?></h2>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <label class="checkbox-inline">
                                    <?php echo \Extension\Form::checkbox('allow_avatar', '1', (isset($allow_avatar) && $allow_avatar == '1' ? true : false), array('id' => 'cfg-allow_avatar', 'class' => 'custom-checkbox')); ?> <?php echo __('config_account_allow_avatar'); ?> 
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cfg-avatar_size" class="col-sm-12"><?php echo __('config_account_avatar_size'); ?>:</label>
                            <div class="col-sm-5">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon"><?php echo __('config_file_size_kb'); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cfg-avatar_allowed_types" class="col-sm-12"><?php echo __('config_account_avatar_allowed_types'); ?>:</label>
                            <div class="col-sm-12">
                                ...
                                <div class="help-block"><?php echo __('config_account_avatar_allowed_types_help'); ?></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cfg-avatar_path" class="col-sm-12"><?php echo __('config_account_avatar_path'); ?>:</label>
                            <div class="col-sm-12">
                                ...
                                <div class="help-block"><?php echo __('config_account_avatar_path_help'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane" id="tabs-email">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="cfg-mail_protocol" class="col-sm-2 control-label"><?php echo __('config_mail_protocol'); ?>:</label>
                            <div class="col-sm-10">
                                <?php 
                                echo \Extension\Form::select('mail_protocol', (isset($mail_protocol) ? $mail_protocol : ''), 
                                    array(
                                        'mail' => __('config_mail_protocol_mail'),
                                        'sendmail' => __('config_mail_protocol_sendmail'),
                                        'smtp' => __('config_mail_protocol_smtp'),
                                    ), 
                                    array(
                        ...
                        <div class="form-group">
                            <label for="cfg-mail_mailpath" class="col-sm-2 control-label"><?php echo __('config_mail_mailpath'); ?>:</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="cfg-mail_smtp_host" class="col-sm-2 control-label"><?php echo __('config_mail_smtp_host'); ?>:</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="cfg-mail_smtp_user" class="col-sm-2 control-label"><?php echo __('config_mail_smtp_user'); ?>:</label>
                            <div class="col-sm-5">
                        ...
                        <div class="form-group">
                            <label for="cfg-mail_smtp_pass" class="col-sm-2 control-label"><?php echo __('config_mail_smtp_pass'); ?>:</label>
                            <div class="col-sm-5">
                        ...
                        <div class="form-group">
                            <label for="cfg-mail_smtp_port" class="col-sm-2 control-label"><?php echo __('config_mail_smtp_port'); ?>:</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <label for="cfg-mail_sender_email" class="col-sm-2 control-label"><?php echo __('config_mail_sender_email'); ?>: <span class="txt_require">*</span></label>
                            <div class="col-sm-5">
                                ...
                                <div class="help-block"><?php echo __('config_mail_sender_email_help'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane" id="tabs-content">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="cfg-content_items_perpage" class="col-sm-2 control-label"><?php echo __('config_content_items_perpage'); ?>: <span class="txt_require">*</span></label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <label for="cfg-content_admin_items_perpage" class="col-sm-2 control-label"><?php echo __('config_content_admin_items_perpage'); ?>: <span class="txt_require">*</span></label>
                            <div class="col-sm-3">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="help-block"><?php echo __('config_media_allowed_types_help'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="help-block"><?php echo __('config_ftp_basepath_help'); ?></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="button" class="btn btn-default test-ftp-btn" onclick="ajax_test_ftp();"><?php echo __('config_test_ftp_connection'); ?></button>
    ...
    function ajax_test_ftp() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.test-ftp-btn').html('<?php echo __('config_test_ftp_connection'); ?>');
            },
            error: function() {
