<h1><?php echo __('siteman_multisite_manager'); ?></h1>

<div class="row cmds">
    <div class="col-sm-6">
        <ul class="actions-inline">
            <li><?php printf(__('admin_total', array('total' => (isset($list_sites['total']) ? $list_sites['total'] : '0')))); ?></li>
            <?php if (\Model_AccountLevelPermission::checkAdminPermission('siteman_perm', 'siteman_add_perm')) { ?><li><?php echo \Html::anchor('admin/siteman/add', __('admin_add'), array('class' => 'btn btn-default')); ?></li><?php } ?> 
        </ul>
    </div>
    <div class="col-sm-6">
        ...
        <table class="table table-striped table-hover">
            ...
            <thead>
                <tr>
                    ...
                    <th><?php echo \Extension\Html::fuelStartSortableLink(array('orders' => 'site_id', 'sort' => $next_sort), $except_querystring, null, __('siteman_site_id')); ?></th>
                    <th><?php echo \Extension\Html::fuelStartSortableLink(array('orders' => 'site_name', 'sort' => $next_sort), $except_querystring, null, __('siteman_site_name')); ?></th>
                    <th><?php echo \Extension\Html::fuelStartSortableLink(array('orders' => 'site_domain', 'sort' => $next_sort), $except_querystring, null, __('siteman_site_domain')); ?></th>
                    <th><?php echo \Extension\Html::fuelStartSortableLink(array('orders' => 'site_status', 'sort' => $next_sort), $except_querystring, null, __('siteman_site_status')); ?></th>
                    <th><?php echo \Extension\Html::fuelStartSortableLink(array('orders' => 'site_create', 'sort' => $next_sort), $except_querystring, null, __('siteman_site_create')); ?></th>
                    <th><?php echo \Extension\Html::fuelStartSortableLink(array('orders' => 'site_update', 'sort' => $next_sort), $except_querystring, null, __('siteman_site_update')); ?></th>
                    <th></th>
                </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <ul class="actions-inline">
                            <?php if (\Model_AccountLevelPermission::checkAdminPermission('siteman_perm', 'siteman_edit_perm')) { ?> <li><?php echo \Extension\Html::anchor('admin/siteman/edit/' . $row->site_id, '<span class="glyphicon glyphicon-pencil"></span> ' . __('admin_edit'), array('class' => 'btn btn-default btn-xs')); ?></li><?php } ?> 
                        </ul>
                    </td>
                </tr>
                <?php } // endofreach; ?> 
                <?php } else { ?> 
                <tr>
                    <td colspan="8"><?php echo __('fslang_no_data'); ?></td>
                </tr>
                <?php } // endif; ?> 
            </tbody>
        </table>
    ...
    <div class="row cmds">
        <div class="col-sm-6">
            ...
            <select name="act" class="form-control select-inline chosen-select select-action">
                ...
                <?php if (\Model_AccountLevelPermission::checkAdminPermission('siteman_perm', 'siteman_edit_perm')) { ?><option value="enable"><?php echo __('admin_enable'); ?></option><?php } ?> 
                <?php if (\Model_AccountLevelPermission::checkAdminPermission('siteman_perm', 'siteman_edit_perm')) { ?><option value="disable"><?php echo __('admin_disable'); ?></option><?php } ?> 
                <?php if (\Model_AccountLevelPermission::checkAdminPermission('siteman_perm', 'siteman_delete_perm')) { ?><option value="del"><?php echo __('admin_delete'); ?></option><?php } ?> 
            </select>
