<h1><?php echo (\Uri::segment(3) == 'add' ? __('accountlv_add_role') : __('accountlv_edit_role')); ?></h1>
...
<?php echo \Extension\Form::open(array('class' => 'form-horizontal', 'role' => 'form')); ?> 
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            <a href="<?php echo \Uri::create('admin/account-level'); ?>" class="btn btn-default"><?php echo __('admin_cancel'); ?></a>
        </div>
    </div>
<?php echo \Form::close(); ?> 