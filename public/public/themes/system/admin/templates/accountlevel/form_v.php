<h1><?php echo (\Uri::segment(3) == 'add' ? \Lang::get('accountlv_add_role') : \Lang::get('accountlv_edit_role')); ?></h1>
...
<?php echo \Extension\Form::open(array('class' => 'form-horizontal', 'role' => 'form')); ?> 
	...
	<div class="form-group">
		<label for="level_name" class="col-sm-2 control-label"><?php echo __('accountlv_role'); ?>: <span class="txt_require">*</span></label>
		<div class="col-sm-5">
	...
	<div class="form-group">
		<label for="level_description" class="col-sm-2 control-label"><?php echo __('accountlv_description'); ?>:</label>
		<div class="col-sm-5">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			...
			<a href="<?php echo \Uri::create('admin/account-level'); ?>" class="btn btn-default"><?php echo \Lang::get('admin_cancel'); ?></a>
		</div>
	</div>
<?php echo \Form::close(); ?> 