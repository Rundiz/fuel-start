<h1><?php echo __('acperm_level_permission_of_module', array('module_name' => $module['name'])); ?></h1>

<div class="row cmds">
    <div class="col-sm-6">
        <?php echo \Extension\Html::anchor('admin/account-permission/index/' . $account_id, '<span class="glyphicon glyphicon-chevron-left"></span> ' . __('acperm_go_back_to_system_permission'), array('class' => 'btn btn-default')); ?> 
    </div>
