...
<?php echo \Form::open(array('class' => 'form-horizontal', 'role' => 'form')); ?> 
	...
	<table class="table table-striped table-responsive list-logins-table">
		<?php 
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo \Extension\Date::gmtDate('', $row->account_last_login); ?></td>
	...
	<div class="row cmds">
		<div class="col-sm-6">
			<select name="act" class="form-control select-inline">
