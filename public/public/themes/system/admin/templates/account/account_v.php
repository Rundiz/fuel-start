...
<div class="row cmds">
	<div class="col-sm-6">
		<?php if (\Model_AccountLevelPermission::checkAdminPermission('account.account_perm', 'account.account_add_perm')) {echo \Html::anchor('admin/account/add', \Lang::get('admin.admin_add'), array('class' => 'btn btn-default'));} ?> 
