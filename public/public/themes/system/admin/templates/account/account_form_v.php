...
<?php echo \Extension\Form::openMultipart(array('class' => 'form-horizontal', 'role' => 'form')); ?> 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo \Extension\Form::input('account_username', (isset($account_username) ? $account_username : ''), array('id' => 'account_username', 'maxlength' => '255', 'class' => 'form-control', (\Uri::segment(3) == 'edit' ? 'readonly' : 'required'))); ?> 
        </div>
    </div>
    <div class="form-group">
