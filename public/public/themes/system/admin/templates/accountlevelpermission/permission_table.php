<?php echo \Form::open(array('action' => 'admin/account-level-permission/save', 'class' => 'form-horizontal', 'role' => 'form')); ?> 
    ...
    <div class="table-responsive">
        <table class="table table-hover table-bordered tableWithFloatingHeader">
            <thead>
                <tr>
                    <th class="perm-page-cell-head"><?php echo __('acperm_permission_page'); ?></th>
                    <th class="perm-action-cell-head"><?php echo __('acperm_permission_action'); ?></th>
                    <?php 
                    $column = 2; 
            ...
            <tbody>
                ...
                ?> 
                <tr>
                    <?php if ($count_act == 1): ?><td rowspan="<?php echo count($perm_actions); ?>" class="perm-page-cell perm-page-row"><?php echo __($perm_page); ?></td><?php endif; ?> 
                    <td class="perm-action-cell<?php if ($count_act == 1): ?> perm-page-row<?php endif; ?>"><?php echo __($perm_action); ?></td>
                    <?php foreach ($list_levels['items'] as $lv) { ?> 
                ...
                <?php } else { ?> 
                <tr>
                    <td colspan="<?php echo $column; ?>"><?php echo __('fslang_no_data'); ?></td>
                </tr>
                <?php } // endif; ?> 
            </tbody>
        </table>
