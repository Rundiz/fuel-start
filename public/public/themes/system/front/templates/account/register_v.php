<article class="general-page-container">
	<h1><?php echo __('account_register'); ?></h1>
	...
	<?php echo \Form::open(array('class' => 'form-horizontal', 'role' => 'form')); ?> 
		...
		<div class="form-group">
			<label for="account_confirm_password" class="col-sm-2 control-label"><?php echo __('account_confirm_password'); ?>: <span class="txt_require">*</span></label>
			<div class="col-sm-7">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				...
				<div>
					<?php echo \Form::input('captcha', $captcha, array('id' => 'account_captcha', 'class' => 'form-control input-captcha', 'placeholder' => __('account_captcha_enter_text_you_see_in_image'))); ?> 
				</div>
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<button type="submit" class="btn btn-primary"><?php echo __('account_submit'); ?></button> <a href="<?php echo \Uri::create('account/resend-activate'); ?>" class="btn btn-default btn-sm"><?php echo \Lang::get('account_didnot_recieve_confirm_registration_email'); ?></a>
			</div>
		</div>
		<?php } // endif; ?> 
	<?php echo \Form::close(); ?> 
	...
	<div class="alert alert-danger">
		...
		<p><?php echo __('account_administrator_does_not_allow_to_register'); ?></p>
	</div>
	<?php } // endif; ?> 
</article>