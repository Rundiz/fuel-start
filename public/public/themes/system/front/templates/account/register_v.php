    ...
    <?php echo \Form::open(array('class' => 'form-horizontal', 'role' => 'form')); ?> 
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="submit" class="btn btn-primary"><?php echo __('account_submit'); ?></button> <a href="<?php echo \Uri::create('account/resend-activate'); ?>" class="btn btn-default btn-sm"><?php echo __('account_didnot_recieve_confirm_registration_email'); ?></a>
            </div>
        </div>
        <?php } // endif; ?> 
    <?php echo \Form::close(); ?> 
