...
<article class="general-page-container">
    <h1><?php echo __('account_login'); ?></h1>
    ...
    <?php echo \Form::open(array('action' => \Uri::main() . (isset($go_to) ? '?rdr=' . $go_to : ''), 'class' => 'form-horizontal', 'role' => 'form')); ?> 
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <label class="bootstrap-tooltip" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo __('account_remember_me_tooltip'); ?>">
                    <?php echo \Form::checkbox('remember', 'yes', (isset($remember) ? $remember : false)); ?> 
                    <?php echo __('account_remember_me'); ?> 
                </label>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <a href="<?php echo \Uri::create('account/forgotpw'); ?>" class="btn btn-default btn-sm"><?php echo __('account_forgot_username_or_password'); ?></a>
            </div>
        </div>
    <?php echo \Form::close(); ?> 
            ...
            success: function(data) {
                ...
                if (data.login_status === true) {
                    ...
                    if (data.show_captcha === true) {
                        ...
                        $('.captcha').attr('src', '<?php echo \Asset::get_file('securimage_show.php', 'img'); ?>?' + Math.random());
                    } else {
