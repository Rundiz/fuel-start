...
<article class="general-page-container page-edit-account">
    <h1><?php echo __('account_edit'); ?></h1>
    ...
    <?php echo \Extension\Form::openMultipart(array('class' => 'form-horizontal', 'role' => 'form')); ?> 
        ...
        <fieldset>
            <legend><?php echo __('account_password'); ?> <small><?php echo __('account_enter_only_when_you_want_to_change'); ?></small></legend>
            <div class="form-group">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <div class="help-block"><?php echo __('account_current_date_time_example', array('time' => \Extension\Date::gmtDate('%Y-%m-%d %H:%M:%S', (string)time(), $row->account_timezone))); ?></div>
                </div>
            </div>
        </fieldset>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <a href="<?php echo \Uri::create('account/view-logins'); ?>" class="btn btn-default btn-sm"><?php echo __('account_login_history'); ?></a>
            </div>
        </div>
        <?php } // endif; ?> 
    <?php echo \Form::close(); ?> 
