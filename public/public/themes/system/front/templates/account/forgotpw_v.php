<article class="general-page-container">
	<h1><?php echo \Lang::get('account_forgot_username_or_password'); ?></h1>
	<p><?php echo \Lang::get('account_please_enter_email_that_is_using_by_your_account'); ?></p>
	...
	<?php echo \Form::open(array('action' => \Uri::main(), 'class' => 'form-horizontal', 'role' => 'form')); ?> 
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="account_email"><?php echo __('account_email'); ?>: <span class="txt_require">*</span></label>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<button type="submit" class="btn btn-primary"><?php echo __('account_send'); ?></button>
			</div>
		</div>
		<?php } // endif; ?> 
	<?php echo \Form::close(); ?> 
